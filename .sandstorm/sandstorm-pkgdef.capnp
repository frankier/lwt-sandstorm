...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "vy7n52k1wfqdvajv13jhamqmcsc6srawh5u92mqv6tud2trw55g0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Learning With Texts"),

    appVersion = 0,  # Increment this for every release.

    appMarketingVersion = (defaultText = "1.6.1"),
    ...
    metadata = (
      ...
      icons = (
        appGrid = (png = (dpi1x = embed "icons/appgrid-128x128.png")),
        grain = (png = (dpi1x = embed "icons/grain-24x24.png")),
        market = (png = (dpi1x = embed "icons/market-150x150.png")),
        marketBig = (png = (dpi1x = embed "icons/market-big-300x300.png")),
      ),

      website = "http://lwt.sourceforge.net/",
      # This should be the app's main website url.

      codeUrl = "https://github.com/lwt-project/lwt",
      # URL of the app's source code repository, e.g. a GitHub URL.
      # Required if you specify a license requiring redistributing code, but optional otherwise.

      license = (publicDomain=(defaultText = embed "UNLICENSE.txt")),
      ...
      author = (
        ...
        contactEmail = "frankie@robertson.name",
        ...
        upstreamAuthor = "Learning With Texts Project",
      ...
      shortDescription = (defaultText = "Language learning tool"),
      ...
      screenshots = [
        ...
        (jpeg = embed "screens/1.jpg"),
        (jpeg = embed "screens/2.jpg"),
        (jpeg = embed "screens/3.jpg"),
      ],
